...
API_ID = int(environ.get('API_ID', '11022834'))
API_HASH = environ.get('API_HASH', '5cb0e343f410dbb7060394f551398540')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://files.catbox.moe/jqrp34.jpeg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1387541507').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002692084975'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002471740770').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002657781674') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4812860858')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002595420647').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://autofilterbotv2o:UTEzd0BpIFYGAE3l@cluster0.a1mmh0m.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "autofilterbotv2.o")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'arcollection')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://files.catbox.moe/sq633x.jpeg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+PFYC9Lr06Ds0NGE9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+MT8SAKIszcBhMWRl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ar_movie_support_group') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/adkrichu')
